package com.clubecerto.apps.app.controllers.events;

import android.util.Log;

import com.clubecerto.apps.app.appconfig.AppConfig;
import com.clubecerto.apps.app.classes.Event;
import com.clubecerto.apps.app.classes.EventNotification;
...
public class EventController {
    ...
    public static void removeAll() {
        ...
        realm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                RealmResults<Event> result = realm.where(Event.class).equalTo("liked", false).findAll();
    ...
    public static List<Event> getLikeEventsAsArrayList() {
        ...
        Realm realm = Realm.getDefaultInstance();
        RealmResults<Event> result = realm.where(Event.class).equalTo("liked", true).findAll();
