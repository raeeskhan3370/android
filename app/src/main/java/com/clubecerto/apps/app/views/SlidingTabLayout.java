...
package com.clubecerto.apps.app.views;
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setCustomTabView(int layoutResId, int textViewId, int ViewNotifyId) {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextColor(getResources().getColorStateList(R.color.TabTitleColor));
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            String titleToUpperCase = (String) adapter.getPageTitle(i);

            tabTitleView.setText(titleToUpperCase.toUpperCase());

            if (Constances.initConfig.ListCats.get(i).getIcon() != 0) {

                if (!AppController.isRTL())
                    tabTitleView.setCompoundDrawablesWithIntrinsicBounds(
                            AppConfig.TabsConfig.get(i).getIcon(), 0, 0, 0);
                else
                    tabTitleView.setCompoundDrawablesWithIntrinsicBounds(
                            0, 0, AppConfig.TabsConfig.get(i).getIcon(), 0);


            } else if (Constances.initConfig.ListCats.get(i).getDrawableIcon() != null) {

                if (!AppController.isRTL())
                    tabTitleView.setCompoundDrawables(
                            AppConfig.TabsConfig.get(i).getDrawableIcon(), null, null, null);
                else
                    tabTitleView.setCompoundDrawables(
                            null, null, AppConfig.TabsConfig.get(i).getDrawableIcon(), null);
