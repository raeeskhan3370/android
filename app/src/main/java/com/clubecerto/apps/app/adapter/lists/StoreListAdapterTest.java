...
public class StoreListAdapterTest extends RecyclerView.Adapter<StoreListAdapterTest.mViewHolder> {
    ...
    public StoreListAdapterTest(Context context, List<Store> data) {
        this.data = data;
    ...
    @Override
    public StoreListAdapterTest.mViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View rootView = infalter.inflate(R.layout.item_store_offer, parent, false);
    ...
    @Override
    public void onBindViewHolder(StoreListAdapterTest.mViewHolder holder, int position) {
...
//        holder.name.setText(data.get(position).getName());
        holder.detail.setText(data.get(position).getAddress());
...
//        }
        ...
        Log.e("Featured",String.valueOf( data.get(position).getFeatured()));
...
//            nbrOffer = itemView.findViewById(R.id.offers);
            offer = itemView.findViewById(R.id.price);
