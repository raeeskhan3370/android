...
import com.clubecerto.apps.app.classes.SimpleImage;
import com.clubecerto.apps.app.views.Blur;
import com.clubecerto.apps.app.views.BlurImageView;
import com.clubecerto.apps.app.views.HackyViewPager;
...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    /*public void setupToolbar(View rootView) {
        ...
        int baseColor = ResourcesCompat.getColor(getResources(), R.color.colorAccent, null);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            Glide.with(getActivity())
                    ...
                    .transform(new Blur(getActivity(), 20))
                    .into(mBlurImageView);
            ...
            Glide.with(getActivity())
                    ...
                    .listener(new RequestListener<Drawable>() {
                        ...
                        public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                            ...
                            Toast.makeText(getActivity(), "Error loading pictures", Toast.LENGTH_LONG).show();
