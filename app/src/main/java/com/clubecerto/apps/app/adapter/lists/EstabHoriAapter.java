...
public class EstabHoriAapter extends RecyclerView.Adapter<EstabHoriAapter.MyViewHolder> {
    ...
    public EstabHoriAapter(Context context, ArrayList<Estable> cartList, MyViewHolder.OnItemSkillClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_estab_destaque, parent, false);
