...
import com.clubecerto.apps.app.GPS.DirectionPointerLinster;
import com.clubecerto.apps.app.GPS.GPStracker;
import com.clubecerto.apps.app.GPS.GetPathFromLocation;
...
public class MapDirectionActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void initMapping() {
        ...
        toolbarTitle.setText(traderName);
                    ...
                    if (distance_config == -1 || distance <= distance_config) {
                        ...
                        gd.setOnDirectionResponseListener(new GoogleDirection.OnDirectionResponseListener() {
                            ...
                            public void onResponse(String status, Document doc, GoogleDirection gd) {
                                ...
                                //mMap.addPolyline(gd.getPolyline(doc, 5,ResourcesCompat.getColor(getResources(), R.color.colorAccent, null)));
                            }
                        });
                    } else {
