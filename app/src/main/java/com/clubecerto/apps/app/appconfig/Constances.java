package com.clubecerto.apps.app.appconfig;
...
public class Constances {
    ...
    public static class API {
        ...
        public static String API_GET_CATEGORIES =  "www.clubecerto.com.br/ws/api/2/estabelecimentos.php?";
        //campaign API's
    ...
    public static class initConfig {
        ...
        public static class Tabs {
            ...
            public static final int ESTAB_OFFERS = -8;
        }
